...
namespace FacultyInformationSystem_FIS_.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<ProfessionalDevelopment> ProfessionalDevelopments => Set<ProfessionalDevelopment>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new College { Id = 1, Name = "College of Engineering" },
            new College { Id = 2, Name = "College of Business" },
            new College { Id = 3, Name = "College of Arts & Sciences" }
            );
